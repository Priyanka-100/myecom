		...
		<div class="row">
			...
			<div class="col-md-4">
				<form>
					...
					<address>
						<strong>Shoptimez, Inc.</strong><br> 795 Folsom Ave, Suite 600<br>
						Bangalore, India 560007<br> <abbr title="Phone">
							Phone:</abbr> (123) 456-7890
					</address>
					<address>
						<strong>Mail us at:</strong><br> <a href="mailto:#">shoptimez.100@yahoomail.com</a>
					</address>
				</form>
			</div>
		</div>
